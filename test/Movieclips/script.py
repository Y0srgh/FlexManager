...
def create_watermark (video):
    ...
    watermark = watermark.set_duration(video.duration).resize(height=video.h * 0.5,width=video.w*0.5).set_pos("center")
    ...
    try:
        ...
        for idx, (line, image_path, audio_clip) in enumerate(
            ...
            if image_path and os.path.exists(image_path):
                ...
                image_clip=crop_to_aspect_ratio(image_clip,4/5)
        ...
        video1 = concatenate_videoclips(video1_clips)
