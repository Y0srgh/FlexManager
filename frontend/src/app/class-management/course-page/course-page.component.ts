...
export class CoursePageComponent implements OnInit {
  ...
  onEdit(courseId: number) {
    // Rediriger vers le formulaire de modification avec l'ID du cours dans l'URL
