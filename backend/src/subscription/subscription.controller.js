...
var SubscriptionsController = function () {
    var _classDecorators = [(0, common_1.Controller)('subscriptions')];
    ...
    var SubscriptionsController = _classThis = /** @class */ (function () {
        function SubscriptionsController_1(subscriptionsService) {
            this.subscriptionsService = (__runInitializers(this, _instanceExtraInitializers), subscriptionsService);
        }
        SubscriptionsController_1.prototype.create = function (createSubscriptionDto) {
            return this.subscriptionsService.create(createSubscriptionDto);
        };
        SubscriptionsController_1.prototype.findAll = function () {
            return this.subscriptionsService.findAll();
        };
        SubscriptionsController_1.prototype.findOne = function (id) {
            return this.subscriptionsService.findOne(Number(id));
        };
        SubscriptionsController_1.prototype.update = function (id, updateSubscriptionDto) {
            return this.subscriptionsService.update(Number(id), updateSubscriptionDto);
        };
        SubscriptionsController_1.prototype.remove = function (id) {
